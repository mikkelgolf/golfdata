...
const SCHOOL_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  // ---- 2026-04-28 audit-team-coords-v2 sweep: 21 teams whose stored
  // ---- coord was >30 mi from canonical campus. Pinning canonical
  // ---- campus coords here so the daily Clippd refresh stops drifting.
